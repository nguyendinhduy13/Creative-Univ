    ...
    >
      <SwiperSlide className="flex justify-center">
        <div>
          ...
          <div className="flex flex-col items-center">
            <p className="font-head text-20 font-semibold mt-5" >Phạm Minh Hoàng</p>
      ...
      <SwiperSlide className="flex justify-center">
        <div>
          ...
          <div className="flex flex-col items-center">
            <p className="font-head text-20 font-semibold mt-5">Nguyễn Minh Chính</p>
      ...
      <SwiperSlide className="flex justify-center">
        <div>
          ...
          <div className="flex flex-col items-center">
            <p className="font-head text-20 font-semibold  mt-5">Nguyễn Đình Giang</p>
      ...
      <SwiperSlide className="flex justify-center">
        <div>
          ...
          <div className="flex flex-col items-center">
            <p className="font-head text-20 font-semibold mt-5">Phạm Hoàng Long</p>
